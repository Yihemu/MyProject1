...
object DataLoader {
  // 定义数据文件路径
  val PRODUCT_DATA_PATH = "E:\\Git\\mymall\\mall-recommendation\\DataLoader\\src\\main\\resources\\products.csv"
  val RATING_DATA_PATH = "E:\\Git\\mymall\\mall-recommendation\\DataLoader\\src\\main\\resources\\ratings.csv"
  // 定义mongodb中存储的表名
