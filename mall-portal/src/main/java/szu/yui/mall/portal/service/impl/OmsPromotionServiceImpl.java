...
import szu.yui.mall.portal.dao.PortalProductDao;
import szu.yui.mall.portal.domain.CartPromotionItem;
import szu.yui.mall.portal.domain.PromotionProduct;
import szu.yui.mall.portal.service.OmsPromotionService;
...
public class OmsPromotionServiceImpl implements OmsPromotionService {
    ...
    public List<CartPromotionItem> calcCartPromotion(List<OmsCartItem> cartItemList) {
        ...
        Map<Integer, List<OmsCartItem>> productCartMap = groupCartItemBySpu(cartItemList);
        //2.查询所有商品的优惠相关信息
        List<PromotionProduct> promotionProductList = getPromotionProductList(cartItemList);
        //3.根据商品促销类型计算商品促销优惠价格
        List<CartPromotionItem> cartPromotionItemList = new ArrayList<>();
        for (Map.Entry<Integer, List<OmsCartItem>> entry : productCartMap.entrySet()) {
     ...
     * 以spu为单位对购物车中商品进行分组
     */
    private Map<Integer, List<OmsCartItem>> groupCartItemBySpu(List<OmsCartItem> cartItemList) {
        Map<Integer, List<OmsCartItem>> productCartMap = new TreeMap<>();
        for (OmsCartItem cartItem : cartItemList) {
     ...
     * 根据商品id获取商品的促销信息
     */
    private PromotionProduct getPromotionProductById(Integer productId, List<PromotionProduct> promotionProductList) {
