...
import szu.yui.mall.service.UmsResourceService;
import szu.yui.security.component.DynamicSecurityService;
...
public class MallSecurityConfig extends SecurityConfig {
    ...
    public DynamicSecurityService dynamicSecurityService() {
        final DynamicSecurityService dynamicSecurityService = new DynamicSecurityService() {
            @Override
